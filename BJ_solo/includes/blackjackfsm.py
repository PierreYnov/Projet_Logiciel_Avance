...
class PlayerHitState(State):
    ...
    def __call__(self, common_vars, button_status):
        ...
        if value_of_players_hand > 21:
            logging.info(type(self).__name__ + ': Joueur a bust {0}'.format(value_of_players_hand))
            common_vars.pause_time = PAUSE_TIMER3
    ...
    def __call__(self, common_vars, button_status):
        ...
        if value_of_dealer_hand == 21:
            logging.info(type(self).__name__ +
                         ': Le Dealer a{0}, le Joueur a {1}'.format(value_of_dealer_hand, value_of_player_hand))
            ...
            logging.info(type(self).__name__ +
                         ': Le dealeur gagne avec {0} sur le joueur {1}'.
    ...
    def __call__(self, common_vars, button_status):
        ...
        if value_of_dealer_hand < 16:
            ...
            if value_of_player_hand > 21:
                ...
                logging.info(type(self).__name__ +
                             ': Le Dealer gagne avec {0} sur le joueur {1}'.
                             format(value_of_dealer_hand, value_of_player_hand))
                plot_results(common_vars.screen, common_vars.text_font,
                             'Le Dealer gagne avec {0} sur le joueur {1}'.
                             format(value_of_dealer_hand, value_of_player_hand))
            ...
            common_vars.pause_time = PAUSE_TIMER3
            logging.info(type(self).__name__ +
                         ': Un push, le dealer a {0}, le joueur a {1}'.
                         format(value_of_dealer_hand, value_of_player_hand))
            plot_results(common_vars.screen, common_vars.text_font,
                         'Un push, le dealer a {0}, le joueur a {1}'.
                         format(value_of_dealer_hand, value_of_player_hand))
            ...
            common_vars.pause_time = PAUSE_TIMER3
            plot_results(common_vars.screen, common_vars.text_font,
                         "Le joueur gagne avec {0} sur le  dealer {1}".format(value_of_player_hand, value_of_dealer_hand))
...
class FinalState(State):
    ...
    def __call__(self, common_vars, button_status):
        ...
        account_text = common_vars.text_font.render("Game Over, vous n'avez plus d'argent", False, GOLD_COLOR)
