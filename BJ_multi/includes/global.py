...
# Paths
IMAGE_PATH = 'img/'
IMAGE_PATH_CARDS = 'img/cards/'
IMAGE_PATH_CHIPS = 'img/casino_chips/'
IMAGE_PATH_BUTTONS = 'img/buttons/'

# Arrière de la carte par défaut
